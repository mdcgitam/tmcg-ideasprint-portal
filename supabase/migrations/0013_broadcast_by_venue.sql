-- Broadcast notifications by room (Venue), in addition to by role. Signature
-- changes from 3 args to 4, so the old overload is dropped explicitly (same
-- reasoning as select_problem_statement in 0003 — create-or-replace can't
