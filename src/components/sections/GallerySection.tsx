...
/**
 * Act 04 — The Energy (prompt.md §13, §43). Previous-year photography as a
  ...
  return (
    <section id="gallery" className="border-t border-border bg-surface px-6 py-28 sm:px-10 lg:px-16">
      <Reveal className="mx-auto mb-14 max-w-7xl">
        <span className="font-mono text-xs tracking-[0.3em] text-gold uppercase">Act 04 — The Energy</span>
