...
/**
 * Act 8 — The Energy (prompt.md §13, §43). Previous-year photography as a
  ...
  return (
    <section id="gallery" className="border-t border-border bg-surface px-6 py-16 sm:px-10 lg:px-16">
      ...
      <div className="mx-auto max-w-4xl">
        {gallery.length === 0 ? (
          <Reveal className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-border-strong bg-void/40 px-6 py-16 text-center">
